...
class Thread {
  ...
  public:
    ...
    Thread(char* debugName,int pri);
    Thread(char* debugName,int pri,int rt);
  ...
  private:
    ...
    int usedTime = 0;  //already ran time
